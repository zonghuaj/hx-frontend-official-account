  ...
  <div class="content">
    ...
    <div class="order">
      ...
      <div class="order-content">
        <span class="order-content-up"><font color="red">*</font>&nbsp;报修内容</span>
        <div class="order-content-down">
          <img src="@/assets/icon/repairs_icon_sr.png" />
          <textarea placeholder="请输入报修内容" rows="3" maxlength="2000" v-model="compliantContent"></textarea>
        </div>
      </div>
